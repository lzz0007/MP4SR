...
class SequentialDataset(Dataset):
    ...
    def data_augmentation(self):
        ...
        new_data = self.inter_feat[target_index] # for every column, for each user, remove its first uid,iid,rating, timestamp
        new_dict = {
        ...
        new_data.update(Interaction(new_dict)) # add item_length, item_id_list_rating_list, timestamp_list to new data
        self.inter_feat = new_data # new_data: user_id/item_id/rating do not have the first item for each user. but item_length/item_id_list/rating_list start from
