...
class FDSA(SequentialRecommender):
    ...
    def forward(self, item_seq, item_seq_len):
        ...
        dense_embedding = self.mlp1(self.desc_tensor[item_seq]).unsqueeze(2)
        dense_embedding_2 = self.mlp2(self.img_tensor[item_seq]).unsqueeze(2)
        ...
        if dense_embedding is not None:
            ...
            feature_table.append(dense_embedding_2)
